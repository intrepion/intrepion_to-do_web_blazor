...
public class ToDoItemGridControls(IPageHelper pageHelper) : IToDoItemFilters
{
    ...
    // Column to sort by.
    public ToDoItemFilterColumns SortColumn { get; set; } = ToDoItemFilterColumns.Title;

    // True when sorting ascending, otherwise sort descending.
    public bool SortAscending { get; set; } = true;

    // Column filtered text is against.
    public ToDoItemFilterColumns FilterColumn { get; set; } = ToDoItemFilterColumns.Title;
