...
public class ToDoItemGridQueryAdapter
{
    ...
    private readonly Dictionary<ToDoItemFilterColumns, Expression<Func<ToDoItem, string>>> expressions =
        new()
        {
            ...
            { ToDoItemFilterColumns.IsCompleted, x => x != null && x.IsCompleted != null ? x.IsCompleted.ToString() : string.Empty },
            { ToDoItemFilterColumns.Ordering, x => x != null ? x.Ordering.ToString() : string.Empty },
            { ToDoItemFilterColumns.Title, x => x != null && x.Title != null ? x.Title : string.Empty },
            // SortExpressionCodePlaceholder
            // { ToDoItemFilterColumns.Name, x => x != null && x.Name != null ? x.Name : string.Empty },
        };
    ...
    public ToDoItemGridQueryAdapter(IToDoItemFilters controls)
    {
        ...
        filterQueries =
            new()
            {
                ...
                // { ToDoItemFilterColumns.Name, x => x.Where(y => y != null && y.Name != null && this.controls.FilterText != null && y.Name.Contains(this.controls.FilterText) ) },
            };
    }
