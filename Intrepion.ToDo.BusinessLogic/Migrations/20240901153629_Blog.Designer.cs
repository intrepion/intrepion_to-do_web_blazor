...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Intrepion.ToDo.BusinessLogic.Entities.BlogPost", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Intrepion.ToDo.BusinessLogic.Entities.BlogPostTag", b =>
                {
            ...
            modelBuilder.Entity("Intrepion.ToDo.BusinessLogic.Entities.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Intrepion.ToDo.BusinessLogic.Entities.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Intrepion.ToDo.BusinessLogic.Entities.Tag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Intrepion.ToDo.BusinessLogic.Entities.BlogPost", b =>
                {
                    ...
                    b.HasOne("Intrepion.ToDo.BusinessLogic.Entities.Category", "Category")
                        .WithMany("BlogPosts")
            ...
            modelBuilder.Entity("Intrepion.ToDo.BusinessLogic.Entities.BlogPostTag", b =>
                {
                    ...
                    b.HasOne("Intrepion.ToDo.BusinessLogic.Entities.BlogPost", "BlogPost")
                        .WithMany("BlogPostTags")
                        .HasForeignKey("BlogPostId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Intrepion.ToDo.BusinessLogic.Entities.Tag", "Tag")
                        .WithMany("BlogPostTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
