...
public partial class ToDoItemAdminPages : PageTest
{
    ...
    public async Task MainNavigation()
    {
        ...
        await Page.GetByLabel("Completed Date and Time:", new() { Exact = true }).FillAsync("2011-01-01");
        ...
        await Page.GetByLabel("Completed Date and Time:", new() { Exact = true }).FillAsync("2022-02-02");
        await Page.GetByLabel("Is Completed?:", new() { Exact = true }).CheckAsync();
